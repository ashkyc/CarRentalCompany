namespace RentalCarCompany.Migrations
{
    ...
    public partial class InitialModel : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        MembershipTierId = c.Byte(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.MembershipTiers", t => t.MembershipTierId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Customers", "MembershipTierId", "dbo.MembershipTiers");
            ...
            DropIndex("dbo.Customers", new[] { "MembershipTierId" });
